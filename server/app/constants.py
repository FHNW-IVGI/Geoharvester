...
url_geoservices_CH_csv = "{}geodata_CH.csv{}".format(url_github_repo,url_github_repo_suffix)
url_geoservices_stats_CH_csv = "{}geodata_CH.csv{}".format(url_github_repo,url_github_repo_suffix)
